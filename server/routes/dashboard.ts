...
router.get('/stats', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
    ...
    const revenueChange = (lastMonthRevenue._sum.paidAmount || 0) > 0
      ? (((thisMonthRevenue._sum.paidAmount || 0) - (lastMonthRevenue._sum.paidAmount || 0)) / (lastMonthRevenue._sum.paidAmount || 1) * 100).toFixed(1)
      : '0';
      ...
      stats: [
        {
          ...
          changeType: parseFloat(patientChange) >= 0 ? "increase" : "decrease",
        ...
        },
        {
          ...
          changeType: parseFloat(appointmentChange) >= 0 ? "increase" : "decrease",
...
router.get('/activities', authenticateToken, async (req: AuthenticatedRequest, res: Response) => {
  try {
    const [
      recentAppointments,
      recentLabResults,
