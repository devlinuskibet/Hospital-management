...
export const validatePatientRegistration: ValidationChain[] = [
  ...
  body('phone').matches(/^\+254[0-9]{9}$/).withMessage('Valid Kenyan phone number is required'),
  ...
  body('emergencyContactPhone').matches(/^\+254[0-9]{9}$/).withMessage('Valid emergency contact phone is required')
];
...
export const validateStaffRegistration: ValidationChain[] = [
  ...
  body('role').isIn(['ADMIN', 'DOCTOR', 'NURSE', 'RECEPTIONIST', 'PHARMACIST', 'LAB_TECH', 'RADIOLOGIST', 'FINANCE', 'RESEARCHER']).withMessage('Valid role is required')
];
...
export const validateAppointment: ValidationChain[] = [
  ...
  body('type').isIn(['CONSULTATION', 'FOLLOW_UP', 'PROCEDURE', 'EMERGENCY', 'ROUTINE_CHECKUP']).withMessage('Valid appointment type is required')
];
...
export const validateLabRequest: ValidationChain[] = [
  ...
  body('urgency').isIn(['ROUTINE', 'URGENT', 'STAT']).withMessage('Valid urgency level is required')
];
