        ...
        <Tabs defaultValue="personal" className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="emergencyPhone" type="tel" placeholder="+254 700 000 000" required />
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="insurance">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <Label className="text-base font-semibold">NHIF Details</Label>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="nhifNumber">NHIF Number</Label>
                      <div className="flex gap-2">
                        <Input id="nhifNumber" placeholder="Enter NHIF number" />
                        <Button 
                          type="button" 
                          variant="outline"
                ...
                <div className="space-y-4">
                  <Label className="text-base font-semibold">Private Insurance</Label>
                  <div className="flex items-center space-x-2">
                    <Checkbox id="hasInsurance" />
                    <Label htmlFor="hasInsurance">Patient has private insurance</Label>
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
